...
![img](JUC.assets/image-20210624111147145.png)



![img](JUC.assets/image-20210624111242536.png)



![img](JUC.assets/image-20210624111004185.png)
...
![img](JUC.assets/image-20210624140725636.png)

问题在于if只会判断一次。而判断过后就wait了, 它醒了之后也不会再判断了.

![img](JUC.assets/image-20210624141324470.png)
...
![img](JUC.assets/image-20210624152428751.png)

# 5. Map不安全的问题

![img](JUC.assets/image-20210624153952863.png)
...
![img](JUC.assets/image-20210624161705855.png)
...
![img](JUC.assets/image-20210624164129125.png)
...
![img](JUC.assets/image-20210624165115354.png)
...
![img](JUC.assets/image-20210624185942750.png)
...
![img](JUC.assets/image-20210624191445883.png)

阻塞队列：BlockingQueue

![img](JUC.assets/image-20210624191553939.png)

多线程和线程池中会使用。

![img](JUC.assets/image-20210624192601788.png)
...
![img](JUC.assets/image-20210624194950835.png)

![img](JUC.assets/image-20210624201611522.png)

![img](JUC.assets/image-20210624202638947.png)

底层

![img](JUC.assets/image-20210624202841196.png)

![img](JUC.assets/image-20210624205550666.png)
...
![img](JUC.assets/912883e51327e0c7a9d753d11896326511272.png)
...
![img](JUC.assets/77441586f6b312a54264e3fcf5eebe2663494.png)
...
![img](JUC.assets/582d1606d57ff99aa0e5f8fc59c7819329028.png)
...
![img](JUC.assets/31bad766983e212431077ca8da92762050214.png)
...
![img](JUC.assets/f4d89c87acf102b45be8ccf3ed83352a9497.png)
...
![img](JUC.assets/49d8041f8480aba5ef59079fcc7143b996706.png)getTask这部分进行了多次判断，为的是控制线程的数量，使其符合线程池的状态。如果线程池现在不应该持有那么多线程，则会返回null值。工作线程Worker会不断接收新任务去执行，而当工作线程Worker接收不到任务的时候，就会开始被回收
...
![img](JUC.assets/03268b9dc49bd30bb63064421bb036bf90315.png)
...
![img](JUC.assets/9d8dc9cebe59122127460f81a98894bb34085.png)

<font color=red>**Worker线程增加**</font>

增加线程是通过线程池中的addWorker方法，该方法的功能就是增加一个线程，该方法不考虑线程池是在哪个阶段增加的该线程，这个分配线程的策略是在上个步骤完成的，该步骤仅仅完成增加线程，并使它运行，最后返回是否成功这个结果。addWorker方法有两个参数：firstTask、core。firstTask参数用于指定新增的线程执行的第一个任务，该参数可以为空；core参数为true表示在新增线程时会判断当前活动线程数是否少于corePoolSize，false表示新增线程前需要判断当前活动线程数是否少于maximumPoolSize，其执行流程如下图所示：

![img](JUC.assets/49527b1bb385f0f43529e57b614f59ae145454.png)
...
![img](JUC.assets/90ea093549782945f2c968403fdc39d415386.png)
...
![img](JUC.assets/879edb4f06043d76cea27a3ff358cb1d45243.png)
...
![img](JUC.assets/image-20210624214044238.png)

> Function：函数型接口

![img](JUC.assets/image-20210624214319915.png)

![img](JUC.assets/image-20210624214327316.png)

> Predicate: 断定型接口

![img](JUC.assets/image-20210624214600727.png)

![img](JUC.assets/image-20210624214540423.png)

> Consumer：消费型接口

![img](JUC.assets/image-20210624214747381.png)

![img](JUC.assets/image-20210624214850176.png)

> supplier: 供给型接口

![img](JUC.assets/image-20210624214921559.png)

![img](JUC.assets/image-20210624215019222.png)
...
![img](JUC.assets/image-20210624215834818.png)

# 13 ForkJoin

分支合并，Forkjoin在JDK 1.7. 并行执行任务!提高效率。大数据量!

![img](JUC.assets/image-20210624220128838.png)

特点：工作窃取

工作窃取: 执行更快的子任务可以去拿执行得慢的子任务去执行，因为维护的都是双端队列

![img](JUC.assets/image-20210624220227163.png)
...
![img](JUC.assets/image-20210625092953849.png)
...
![img](JUC.assets/image-20210625100327008.png)

# CAS(Compare and Swap)

![img](JUC.assets/image-20210625101959949.png)

![img](JUC.assets/image-20210625102137039.png)

CAS :比较当前工作内存中的值（期望值）和主内存中的值,如果这个值是期望的,那么则执行操作!如果不是就一 直循环!

ABA问题：

![img](JUC.assets/image-20210625102740763.png)

![img](JUC.assets/image-20210625103040474.png)

**原子引用`AtomicReference`（解决ABA）：**带版本号的原子操作

![img](JUC.assets/image-20210625104156484.png)
...
![img](JUC.assets/image-20210625104643250.png)
